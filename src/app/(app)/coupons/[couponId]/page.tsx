...
import { getGroups } from "@/lib/api/groups/queries";import OptimisticCoupon from "@/app/(app)/coupons/[couponId]/OptimisticCoupon";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticCoupon coupon={coupon} groups={groups} />
      </div>
    </Suspense>
  );
};
